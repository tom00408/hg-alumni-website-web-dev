					...
					<form
						...
						<div class="form-fields">
							<div class="form-field">
								...
								<select
									...
									class="form-input"
									:class="{
										'form-input--error': errors.salutation,
									}"
									required>
							...
							<div class="form-field">
								...
								<input
									...
									required />
								<span v-if="errors.city" class="form-error">{{
									errors.city
								}}</span>
							</div>
							...
							<div class="form-field">
								<label for="occupation" class="form-label"
									>Beruf (ggf. Studienrichtung)</label
								>
								<input
									id="occupation"
						...
						<div class="form-fields">
							...
							<div class="form-field">
								<label class="form-label"
									>Besuch des Hainberg-Gymnasiums:</label
								>
						...
						<div class="membership-declaration">
							<p class="declaration-text">
								<strong
									>Ja, ich möchte Mitglied des Alumnivereins
									des Hainberg-Gymnasiums Göttingen e.V.
									werden.</strong
								>
							</p>
							<p class="declaration-text">
								Ich ermächtige den Verein außerdem widerruflich,
								den von mir zu entrichtenden Mitgliedsbeitrag
								bei Fälligkeit zu Lasten meines unten
								angegebenen Kontos durch Lastschrift
								einzuziehen. Der Mitgliedsbeitrag beträgt für
								Auszubildende und Studenten 10€ und für
								Berufstätige 20€ im Jahr.
							</p>
						</div>
						...
						<div class="form-fields">
							<div class="form-field">
								<label for="placeDate" class="form-label"
									>Ort, Datum *</label
								>
								<input
									id="placeDate"
									...
									:class="{
										'form-input--error': errors.placeDate,
									}"
									placeholder="Göttingen, 01.01.2024"
									required />
								<span
									v-if="errors.placeDate"
									class="form-error"
									>{{ errors.placeDate }}</span
								>
							</div>
							...
							<div class="form-field">
								...
								<input
									...
									class="form-input form-input-underline"
									:class="{
										'form-input--error': errors.signature,
									}"
						...
						<div class="form-group">
							...
							<span v-if="errors.consent" class="form-error">{{
								errors.consent
							}}</span>
						</div>
				...
				<div v-if="submitted" class="success-message">
					<HgCard variant="secondary">
						<div class="success-content">
							...
							<p>
								Wir haben Ihren Mitgliedsantrag erhalten und
								werden uns in Kürze bei Ihnen melden. Sie
								erhalten auch eine Bestätigungs-E-Mail an die
								angegebene Adresse.
							</p>
						</div>
					</HgCard>
...
const benefits = [
	...
	},
	{
		...
		description:
			'Exklusiver Zugang zu Alumni-Treffen, Vorträgen und Schulveranstaltungen',
		icon: `<svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor">
...
const validateForm = () => {
	...
	if (!form.placeDate.trim()) {
		...
		errors.value.placeDate =
			'Ort und Datum müssen mindestens 3 Zeichen haben';
	}
	...
	if (!form.signature.trim()) {
		...
		errors.value.signature =
			'Unterschrift muss mindestens 2 Zeichen haben';
	}
